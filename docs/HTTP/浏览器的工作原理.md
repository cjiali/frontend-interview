...
![img](https://www.html5rocks.com/zh/tutorials/internals/howbrowserswork/image046.jpg)图：CSS2 框模型
...
![img](https://www.html5rocks.com/zh/tutorials/internals/howbrowserswork/image057.png)图：block 框

inline 框：没有自己的 block，但是位于容器 block 内。

![img](https://www.html5rocks.com/zh/tutorials/internals/howbrowserswork/image059.png)图：inline 框

block 采用的是一个接一个的垂直格式，而 inline 采用的是水平格式。

![img](https://www.html5rocks.com/zh/tutorials/internals/howbrowserswork/image061.png)图：block 和 inline 格式

inline 框放置在行中或“行框”中。这些行至少和最高的框一样高，还可以更高，当框根据“底线”对齐时，这意味着元素的底部需要根据其他框中非底部的位置对齐。如果容器的宽度不够，inline 元素就会分为多行放置。在段落中经常发生这种情况。

![img](https://www.html5rocks.com/zh/tutorials/internals/howbrowserswork/image063.png)图：行
...
![img](https://www.html5rocks.com/zh/tutorials/internals/howbrowserswork/image065.png)图：相对定位
...
![img](https://www.html5rocks.com/zh/tutorials/internals/howbrowserswork/image067.png)图：浮动

#### 绝对定位和固定定位

这种布局是准确定义的，与普通流无关。元素不参与普通流。尺寸是相对于容器而言的。在固定定位中，容器就是可视区域。

![img](https://www.html5rocks.com/zh/tutorials/internals/howbrowserswork/image069.png)图：固定定位
...
![img](https://www.html5rocks.com/zh/tutorials/internals/howbrowserswork/image071.png)图：固定定位
